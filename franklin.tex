...
are more likely to be clustered together in this sequence.  In the next
two lemmas, we show that, by giving up this iid property we get a larger
subset of $L$ and that by interleaving the functions $Q_t$ and $F_t$
we again obtain an iid sequence.
